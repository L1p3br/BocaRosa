...
function vRPbs.hairOverlay(model,colorp, colors)
	if model and color then
		custom.hairModel = parseInt(model)
		custom.firstHairColor = parseInt(colorp)
		custom.secondHairColor = parseInt(colors)
	else
		custom.hairModel = currentCharacterMode.hairModel
		custom.firstHairColor = currentCharacterMode.firstHairColor		
		custom.secondHairColor = currentCharacterMode.secondHairColor	
...
function vRPbs.lipOverlay(model,color)
	if model and color then
		custom.lipstickModel = parseInt(model)
		custom.lipstickColor = parseInt(color)
	else
		custom.lipstickModel = currentCharacterMode.lipstickModel
		custom.lipstickColor = currentCharacterMode.lipstickColor		
	end
...
function vRPbs.blushOverlay(model,color)
	if model and color then
		custom.blushModel = parseInt(model)
		custom.blushColor = parseInt(color)
	else
		custom.blushModel = currentCharacterMode.blushModel
		custom.blushColor = currentCharacterMode.blushColor		
	end
...
function vRPbs.makeOverlay(model)
	if model then
		custom.makeupModel = parseInt(model)
	else
		custom.makeupModel = currentCharacterMode.makeupModel
	end
end

function vRPbs.eyeOverlay(model)
	if model then
		custom.eyesColor = parseInt(model)
	else
		custom.eyesColor = currentCharacterMode.eyesColor	
	end
end
